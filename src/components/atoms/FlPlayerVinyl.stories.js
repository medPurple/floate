import FlPlayerVinyl from './FlPlayerVinyl.vue'

export default {
  title: 'Atoms/FlPlayerVinyl',
  component: FlPlayerVinyl,
  tags: ['autodocs'],
  argTypes: {
    state: {
      control: 'select',
...
const Template = (args) => ({
  components: { FlPlayerVinyl },
  setup: () => ({ args }),
  template: `
    <div style="padding: 32px; background: var(--bg);">
      <FlPlayerVinyl v-bind="args" />
    </div>
  `
})
...
// Vue d'ensemble : les 4 états côte à côte pour comparer.
